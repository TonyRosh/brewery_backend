...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { alcohol: @beer.alcohol, description: @beer.description, ibu: @beer.ibu, name: @beer.name, style: @beer.style } }, as: :json
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { alcohol: @beer.alcohol, description: @beer.description, ibu: @beer.ibu, name: @beer.name, style: @beer.style } }, as: :json
    assert_response 200
  end
